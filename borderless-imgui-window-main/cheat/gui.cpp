...
void gui::Render() noexcept
{
	...
	if (ImGui::BeginChild(
		...
		if (ImGui::Button("Aiming", { ImGui::GetContentRegionAvail().x, button_height })) { current_tab = 0; }
		if (ImGui::Button("Visuals", { ImGui::GetContentRegionAvail().x, button_height })) { current_tab = 1; }
		if (ImGui::Button("Movement", { ImGui::GetContentRegionAvail().x, button_height })) { current_tab = 2; }
	...
	if (ImGui::BeginChild(
		...
		case 0:
			...
			ImGui::SliderInt("Aimbot Smoothing", &aimbotfloat, 1, 100);
			ImGui::SliderInt("Aimbot FOV", &aimbotfov, 1, 90);
		...
		case 1:
			...
			ImGui::ColorEdit4("Glow color", globals::enemyColor);

			ImGui::Spacing();

			ImGui::Checkbox("Glow Team", &globals::glowteam);
			ImGui::ColorEdit4("Glow Team color", globals::teamColor);
